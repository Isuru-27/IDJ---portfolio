...
const DownloadButton = styled.a`
  ...
  font-family: 'Karla', sans-serif;
  position: absolute;
  top: calc(100% - 100px); /* Position it towards the bottom */
  left: 50%;
...
const Main = () => {
  ...
  return (
    <MainContainer>
        <ParticleComponent theme='light' /> {/* Add the ParticleComponent here */}
      <DarkDiv click={click} />
      <Container>
        <PowerButton />
        ...
        <Center click={click}>
          ...
          <span><h2>ℭ𝔩𝔦𝔠𝔨 ℌ𝔢𝔯𝔢</h2></span>
        </Center>

        <Contact target="_blank" href="mailto:dilshanisuru2000@gmail.com">
          <motion.h2
